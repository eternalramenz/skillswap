import { declineRequest, fetchFollowerStatus, followAccept, followRequest} from '../../../redux/api/UserRequest.ts'
...
const ProfileFollowerCard = ({props, setOpenFollowersDrawer}) => {
  ...
  const fetchStatus = async () => { 
    const { data } = await fetchFollowerStatus(userInformation._id, props._id)
    return data || [];
  }
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div>
          ...
          { data.followerStatus[0]?.status === "accepted" &&
