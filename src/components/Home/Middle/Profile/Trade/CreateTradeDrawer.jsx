...
import MeetingTypeButton from "./MeetingTypeButton.jsx";
import { createTradeNotification } from '../../../../../redux/api/NotificationRequest.ts'

const CreateTradeDrawer = ({ openTradeDrawer, setOpenTradeDrawer}) => {
    ...
    <Drawer openTradeDrawer={openTradeDrawer} setOpenTradeDrawer={setOpenTradeDrawer}>
      <div className="flex flex-col pl-6 pr-4 py-10 transition-all relative">
        ...
        <div className="flex items-center justify-end mt-12 gap-2">
          <button className="bg- font-main text-darkBlue  py-2 px-4 dark:text-darkWhite text-sm" onClick={() => {setOpenTradeDrawer((prev) => !prev) ; handleClearForm()}}>Cancel</button>
          <button 
...
export default CreateTradeDrawer