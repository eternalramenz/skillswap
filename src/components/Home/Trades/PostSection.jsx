...
import { uploadPost } from '../../../redux/api/ProfileRequest.ts'
...
const PostSection = ({ data,  setOpenTradeDrawer, setToggleEdit}) => {
  ...
  const handleSubmit  = async (e) => {
    ...
    try {
      ...
      imageObjects.forEach((imageObject) => {
        newPostData.images.push(imageObject.data);
      });
    ...
    try {
      ...
      const newNotificationData = {
        ...
        type:"tradePosted",
        text: "has posted their experience about your trade",      
      } 
    ...
    queryClient.removeQueries(['profilePost'])
    ...
    <div className="flex flex-col pl-6 pr-4 py-10 transition-all relative h-full">
      ...
      <div className="w-full items-center justify-end flex mt-12">
        ...
        <button 
          ...
          className={`${isDisabled || isLoading ? "bg-gray cursor-not-allowed" : "bg-Primary "} font-main text-white rounded-lg py-2 px-8 text-sm`}
