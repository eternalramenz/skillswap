    ...
    <div>
      ...
      >
        <path 
          ...
          className={`${state ? 'stroke-white fill-white dark:stroke-lightBlack dark:fill-lightBlack' : 'stroke-gray fill-white dark:stroke-darkWhite dark:fill-lightBlack'}`}
          strokeWidth="2" 
          strokeLinecap="round" 
        ...
        <path 
          ...
          className={`${state ? 'stroke-Primary fill-Primary ' : 'stroke-gray fill-white dark:stroke-darkWhite dark:fill-lightBlack'}`}
          strokeWidth="2" 
          strokeLinecap="round" 
          strokeLinejoin="round"
        />
