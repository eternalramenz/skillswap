    ...
    <div>
      ...
      >
        <path 
          ...
          className={`${state ? 'stroke-white fill-white dark:fill-lightBlack dark:stroke-lightBlack' : 'stroke-gray dark:stroke-darkWhite'}`}
          strokeWidth="2" 
          strokeLinecap="round" 
        ...
        <path 
          ...
          strokeWidth="2" 
          className={`${state ? 'stroke-Primary fill-Primary' : 'stroke-gray dark:stroke-darkWhite'}`}
          strokeLinecap="round" 
          strokeLinejoin="round"
        />
      </svg>
